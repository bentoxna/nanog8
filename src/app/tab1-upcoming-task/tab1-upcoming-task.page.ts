...
@Component({
  selector: 'app-tab1-upcoming-task',
  templateUrl: './tab1-upcoming-task.page.html',
  styleUrls: ['./tab1-upcoming-task.page.scss'],
})
export class Tab1UpcomingTaskPage implements OnInit {
