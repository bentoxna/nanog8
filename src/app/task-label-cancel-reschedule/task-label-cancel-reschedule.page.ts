...
@Component({
  ...
  templateUrl: './task-label-cancel-reschedule.page.html',
  styleUrls: ['./task-label-cancel-reschedule.page.scss'],
})
export class TaskLabelCancelReschedulePage implements OnInit {
