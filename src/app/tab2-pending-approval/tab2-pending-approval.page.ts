...
@Component({
  selector: 'app-tab2-pending-approval',
  templateUrl: './tab2-pending-approval.page.html',
  styleUrls: ['./tab2-pending-approval.page.scss'],
})
export class Tab2PendingApprovalPage implements OnInit {
