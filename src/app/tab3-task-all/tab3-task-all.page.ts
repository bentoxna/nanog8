...
import { IonGrid, ModalController, NavController, Platform } from '@ionic/angular';
...
@Component({
  selector: 'app-tab3-task-all',
  templateUrl: './tab3-task-all.page.html',
  styleUrls: ['./tab3-task-all.page.scss'],
})
export class Tab3TaskAllPage implements OnInit {
  ...
  ngOnInit() {
    console.log(this.heighter())
      ...
      this.monthDate1 = (this.months2[new Date().getMonth()]) + ' ' + (new Date().getFullYear())
      this.monthfirstday1 = new Date(this.monthDate1).getTime()
      this.monthlastday1 =new Date((new Date().getFullYear()), (new Date().getMonth() + 1)  , 0, 23,59,59).getTime()
      console.log(this.monthfirstday1, this.monthlastday1)

      this.monthDate2 = (this.months2[new Date().getMonth()]) + ' ' + (new Date().getFullYear())
      this.monthfirstday2 = new Date(this.monthDate2).getTime()
      this.monthlastday2 =new Date((new Date().getFullYear()), (new Date().getMonth() + 1)  , 0, 23,59,59).getTime()
      console.log(this.monthfirstday2, this.monthlastday2)

      this.monthDate3 = (this.months2[new Date().getMonth()]) + ' ' + (new Date().getFullYear())
      this.monthfirstday3 = new Date(this.monthDate3).getTime()
      ...
      this.http.post('https://api.nanogapp.com/getAppointmentForExecByDate', { execId: this.userid, startDate: this.monthfirstday1, endDate: this.monthlastday1 }).subscribe((s) => {
        console.log(s)
        this.appointmentByMonth =  s['data'].filter(a =>( (a['phone_row_number'] == 1 && a['address_row_number'] == 1) || a['verified'] == true || a['warranty_id']) && (!a['sales_status'] || a['sales_status'] == 'Quotation') && !a['whole_status'])
  ...
  choosedate(x){
    if(x == 1)
    {
      this.monthdatetab1 = !this.monthdatetab1
    }
    else if(x == 2)
    {
      this.monthdatetab2 = !this.monthdatetab2
    }
    else if(x == 3)
    {
      this.monthdatetab3 = !this.monthdatetab3
    }
  ...
  getchoosedate(){
    ...
    if(this.dengdengdengdeng == 1)
    {
      ...
      {
        console.log(this.monthYear1)
        console.log(new Date(this.monthYear1).getTime())
        let temp = new Date(this.monthYear1).getTime()
        this.monthDate1 = (this.months2[new Date(temp).getMonth()]) + ' ' + (new Date(temp).getFullYear())
        console.log(this.monthDate1)
        this.monthfirstday1 = new Date(this.monthDate1).getTime()
        this.monthlastday1 =new Date((new Date(temp).getFullYear()), (new Date(temp).getMonth() + 1)  , 0,23,59,59).getTime()
        console.log(this.monthfirstday1, this.monthlastday1)
        this.monthdatetab1 = false
    ...
    else if(this.dengdengdengdeng == 2)
    {
      if(!this.monthYear2)
      {
        this.monthDate2 = (this.months2[new Date().getMonth()]) + ' ' + (new Date().getFullYear())
      ...
      {
        console.log(this.monthYear2)
        console.log(new Date(this.monthYear2).getTime())
        let temp = new Date(this.monthYear2).getTime()
        this.monthDate2 = (this.months2[new Date(temp).getMonth()]) + ' ' + (new Date(temp).getFullYear())
        console.log(this.monthDate2)
        this.monthfirstday2 = new Date(this.monthDate2).getTime()
        this.monthlastday2 =new Date((new Date(temp).getFullYear()), (new Date(temp).getMonth() + 1)  , 0,23,59,59).getTime()
        console.log(this.monthfirstday2, this.monthlastday2)
        this.monthdatetab2 = false
    ...
    else if(this.dengdengdengdeng == 3)
    {
      if(!this.monthYear3)
      {
        this.monthDate3 = (this.months2[new Date().getMonth()]) + ' ' + (new Date().getFullYear())
      ...
      {
        console.log(this.monthYear3)
        console.log(new Date(this.monthYear3).getTime())
        let temp = new Date(this.monthYear3).getTime()
        this.monthDate3 = (this.months2[new Date(temp).getMonth()]) + ' ' + (new Date(temp).getFullYear())
        console.log(this.monthDate3)
        this.monthfirstday3 = new Date(this.monthDate3).getTime()
        this.monthlastday3 =new Date((new Date(temp).getFullYear()), (new Date(temp).getMonth() + 1)  , 0,23,59,59).getTime()
        console.log(this.monthfirstday3, this.monthlastday3)
        this.monthdatetab3 = false
  ...
  changedengdengdengdeng(x)
  {
    this.dengdengdengdeng = x
    this.getchoosedate()
  }
